...
public:
    ...
    // B+ tree root page id stored in meta. 0 means "no tree yet".
    Page::PageId btree_root() const { return btree_root_; }
    void set_btree_root(Page::PageId id);
